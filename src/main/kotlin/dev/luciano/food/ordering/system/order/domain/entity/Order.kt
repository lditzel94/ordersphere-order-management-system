...
import dev.luciano.food.ordering.system.order.domain.valueobject.StreetAddress
import dev.luciano.food.ordering.system.order.domain.valueobject.TrackingId
...
fun Order.initiate(): Order.Pending = Order.Pending(
    orderId = orderId,
